...
% Bases ------------------------------------------------------------------------
\newcommand{\Span}{\fn{\op{Span}}}
\newcommand{\rank}{\fnpr{\op{rank}}}
\newcommand{\dimension}{\fnpr{\dim}}
    % \dim is built-in

% Matrices ---------------------------------------------------------------------

\newcommand{\diagonal}{\fnpr{\op{diag}}}
    \newcommand{\diag}{\diagonal}
\newcommand{\trace}{\fnpr{\op{tr}}}
    \newcommand{\tr}{\trace}
...
\newcommand{\Columnspace}{\fnpr{\op{Col}}}
    \newcommand{\Colspace}{\Columnspace}
    \newcommand{\Col}{\Columnspace}
\newcommand{\Rowspace}{\fnpr{\op{Row}}}
    \newcommand{\Row}{\Rowspace}
\newcommand{\Nullspace}{\fnpr{\op{Null}}}
...
\newcommand{\Range}{\fnpr{\op{Range}}}
\newcommand{\Kernel}{\fnpr{\op{Ker}}}
    \newcommand{\Ker}{\Kernel}
\newcommand{\nullity}{\fnpr{\op{nullity}}}

% Coordinates ------------------------------------------------------------------

\newcommand{\coordinates}[2]{{\mat{ #1 }_{ #2 }}}
...
\newcommand{\mapmatrix}[3]{\lsub{\mat{ #2 }}{ #1 }_{ #3 }}
...
\newcommand{\projection}[1]{\fnpr{\op{proj}_{#1}}}
    \newcommand{\proj}{\projection}
\newcommand{\perpendicular}[1]{\fnpr{\op{perp}_{#1}}}
    % \perp is reserved
